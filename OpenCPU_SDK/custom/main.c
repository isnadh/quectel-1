 ...
 *END*******************************************************************/
/*
 * This proper working code of led blinking
 * */
#ifdef __MQTT_TEST__
...
//******user defie*****************//
char Phone_Number[11]="9021246889";

char Message[50]="HEllo Quectel\n";
//----- Service provide APN
char m_apn[50] = {'\0'};
...
void proc_main_task(s32 taskId)
{
	...
	while(TRUE)
	{
		...
		Ql_Sleep(1000);
		APP_DEBUG("\nLED ON\r\n");
//		SMS_SendSMS_Text(Phone_Number, 10 , 0, Message ,15 , NULL);
